...
export default function ProtectedInput({placeholder, name}: {placeholder: string, name: string}) {
    ...
    return (
        <div className="protected-input">
            <input type={isHidden ? "password" : "text"} placeholder={placeholder} required name={name} />
