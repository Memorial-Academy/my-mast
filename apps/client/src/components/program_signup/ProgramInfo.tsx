            ...
            <div>
                ...
                <p>
                    ...
                    <>
                        <b>Virtual</b>
                        <br/>
                        Links will be sent to {props.signupType == "enroll" ? "enrolled parents/students" : "signed-up volunteers"} via email and immediately viewable on their MyMAST dashboard upon signup.
                    </> : <>
